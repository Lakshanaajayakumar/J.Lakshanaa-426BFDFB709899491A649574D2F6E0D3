'''Implement a class called Bank Account that represents a bank aacount.The class should have private 
attributes for account number,holder name and account balance.Include methods to 
